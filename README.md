...
**Windows** — download and run the installer from [Releases](https://github.com/cordfuse/toneai-nux-cli/releases)
...
**macOS (pkg):** Download `tnqr-macos.pkg` from [Releases](https://github.com/cordfuse/toneai-nux-cli/releases).
